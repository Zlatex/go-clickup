...
[![Go Reference](https://pkg.go.dev/badge/github.com/Zlatex/go-clickup/clickup.svg)](https://pkg.go.dev/github.com/Zlatex/go-clickup/clickup)
...
It is go gettable
```
go get github.com/Zlatex/go-clickup
```
...
cat > go.mod <<-END
  ...
  require github.com/Zlatex/go-clickup main
END
